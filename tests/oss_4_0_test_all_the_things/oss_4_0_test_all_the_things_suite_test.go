...
var (
	testName     = "OSS 4.0 smoke test"
	namespace    = "test-oss-4-0-smoke-test"
	dcName       = "dc1"
	dcYaml       = "../testdata/oss-three-rack-three-node-4-0-dc.yaml"
...
var _ = Describe(testName, func() {
	Context("when in a new cluster", func() {
		Specify("the operator can scale up, stop, resume, and terminate a Cass 4.0 dc", func() {
